...
namespace WingTipToysMSDN.Logic
{
    public class CartActions : IDisposable
    {
        public string ShoppingCartId { get; set; }

        private SeasonContext _db = new SeasonContext();
        ...
        {
            using (var db = new WingTipToysMSDN.Models.SeasonContext()) {
                try {
        ...
        {
            using (var _db = new WingTipToysMSDN.Models.SeasonContext()) {
                try {
